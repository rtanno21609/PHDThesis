\chapter{Uncertainty in Multitask Learning (II): Stochastic Filter Groups for Learning Strucutred Sparsity}\label{chapter:multitaskuncertainty_part2}
