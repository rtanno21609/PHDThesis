...
\begin{figure}[ht]
	\center
% 	\vspace{-3mm}
	\includegraphics[width=0.7\linewidth]{chapter_6/figures/forward_and_backward.pdf}
...
\subsection{T+1 Way ``Drop-Out'' for optimisation}
