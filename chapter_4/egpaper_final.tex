...
%%%%%%% Comment out to include page number:
\thispagestyle{empty}
...
\author{Ryutaro Tanno$^{1}$ \thanks{A part of the work done during internship at Butterfly Network.} \quad \quad Ardavan Saeedi$^{2}$ \quad \quad
Swami Sankaranarayanan$^{2}$ \\ \quad \quad
Daniel C. Alexander$^{1}$ \quad \quad
Nathan Silberman$^{2}$ \\
%\vspace{0.3in}
    $^1$University College London, UK  \quad \quad 
    $^2$Butterfly Network, New York, USA \\
    \vspace{0.in}
    $^1$ {\tt\footnotesize \{r.tanno, d.alexander\}@ucl.ac.uk} \quad \quad 
	$^2${\tt\tt\footnotesize\{asaeedi,swamiviv,nsilberman\}@butterflynetinc.com}\\
\vspace{-0.4in}
}
...
% In this work, we present a method for jointly learning the label noise of individual annotators and the true label distribution from purely noisy observations. The method achieves the separation of the two by encouraging the estimated annotators to be maximally unreliable while achieving high fidelity with the training data.

% Access to clean labelled datasets is a piece of luxury confined to academic research for many machine learning applications. In practice, the labels are noisy, typically obtained from multiple annotators of varying skill levels and biases. Blindly assuming labels to be accurate limits the performance of deployed machine learning systems. This problem is pervasive in domains such as medical imaging and astronomy where the cost of data acquisition and labelling is high. In this work, we will present a method that is capable of learning. With an addition 

% Access to clean and voluminous datasets is a piece of luxury confined to academic research for many machine learning applications. In practice, such datasets are hard to come by, and consequently limit the performance of deployed machine learning systems. This problem is pervasive in medical imaging applications where the cost of data acquisition and labelling is high. In this work, we will present a method that is capable of learning more intelligently from such noisy data by modelling the human annotation process. This is particularly relevant in situations where data is labelled by multiple annotators of varying skill levels and biases. \textcolor{red}{Too general. Rewrite entirely.}
\end{abstract}
\vspace{-5mm}
%%%%%%%%%%%%%%%%%%%%%%%% Introduction %%%%%%%%%%%%%%%%%%%%%%%%%%
...
% pronounced in the early stage of crowd-sourcing where the number of annotations is limited or in domains such as medical image analysis where the cost of label acquisition is high.  

%In the last few years, deep learning techniques have permeated the field of medical image processing [1,2]. Modern research in automation of radiological tasks through deep learning have shown a great promise in an array of applications such as segmentation [3], detection [4], disease grading and classification 
...
\begin{figure*}[ht]
	\center
	\vspace{-5mm}
	\includegraphics[width=0.75\linewidth]{figures/model_schematic_2.png}
	\small
	\vspace{-2mm}
...
\begin{figure*}[h]
    ...
    \begin{center}
		%\framebox[4.0in]{$\;$}
		\includegraphics[width=0.8\linewidth]{figures/figure_cifar10_visualization_of_confusion_matrices_03.png}
	\end{center}
	\vspace{-6mm}
...
% 	\vspace{-2mm}
	\begin{subfigure}[]{1.0\linewidth}
		\includegraphics[width=\linewidth]{figures/figures_new/figure_3_ab.png}
	\end{subfigure}
	\hspace{10mm}
	\begin{subfigure}[]{1.0\linewidth}
		\includegraphics[width=\linewidth]{figures/figures_new/figure_3_cd.png}
	\end{subfigure}
...
\begin{figure}[t]
	\center
	\vspace{-2mm}
	\includegraphics[width=\linewidth]{figures/figures_new/figure_4.png}
	\vspace{-7mm}
...
% 		\includegraphics[width=\linewidth]{figures/figure_convergence_rate_allcombined_05.png}
% 	\end{subfigure}
% % 	\hspace{0.5\linewidth}
% 	\begin{subfigure}[]{0.48\linewidth}
% 		\includegraphics[width=\linewidth]{figures/figure_frobeniusnorm_allcombined_07.png}
% 	\end{subfigure}
% 	\caption{Curves of validation accuracy (top) and the quality of CM estimation (bottom) during training of our method, generalized EM and MBEM for a range of hyper-parameter specifications. For our method, we experimented varying the scaling of the trace regularizer in the range $[0.001, 0.01, 0.1]$. For both EM and MBEM, we varied the number of EM steps, denoted by T, and the number of gradient descent steps per E-step, denoted by $G$ while fixing the total number of training iterations at $100,000$.}
...
\begin{figure}[ht]
	\center
	\vspace{-2mm}
	\includegraphics[width=0.97\linewidth]{figures/figures_new/figure_5.png}
	\vspace{-2mm}
...
\begin{figure}[ht]
	...
	\begin{center}
		%\framebox[4.0in]{$\;$}
		\includegraphics[width=\linewidth]{figures/figures_new/figure_6.png}
	\end{center}
 	\vspace{-7mm}
...
% 	
	...
	\begin{subfigure}[]{0.6\linewidth}
 		\vspace{-2mm}
		\includegraphics[width=\linewidth]{figures/figure_cardiac_views_02.png}
 		\vspace{-6mm}
	...
	\begin{subfigure}[]{0.22\linewidth}
		\includegraphics[width=0.9\linewidth]{figures/figure_real_us_annotator_clustering_03.png}
		\vspace{-2mm}
		\caption{Skill estimation}
	\end{subfigure}
	\hspace{0mm}
	\begin{subfigure}[]{0.35\linewidth}
		\includegraphics[width=\linewidth]{figures/figure_real_us_cms_visualization_02.png}
		\vspace{-5mm}
		 \caption{Learned CMs}
	\end{subfigure}
	\hspace{0mm}
...
% \textbf{Multiple schools of thoughts:} \cite{saeedi2017multimodal,kohl2018probabilistic}

% \textbf{Assumptions of input independence and independent annotators:}
% \textbf{}
